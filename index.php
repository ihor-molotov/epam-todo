            ...
            array(
                'username' => array(
                    ...
                    'regexp' => array(
                        ...
                        'Username is only English alphabets, numbers and underscores'
                    )
                ),
                'password' => array(
            ...
            if (!$query->error()) {
                if ($query->count()) {
                    if ($query->first()->password === Hash::make(Input::get('password'), $query->first()->salt)) {
                        ...
                        Session::flash(
                            'password',
                            'You have entered a wrong password or you had chosen a used username.'
                        );
                    }
                } else {
                    //sign him up
...
<head>
    ...
    <meta id="csrf_token" content="<?php
    echo Token::generate('csrf_token'); ?>"/>
</head>
<body>
<script>
        ...
        <?php
            ...
            <div class='loginbox'>
                ...
                echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                    ...
                    <input type="hidden" name="csrf_login" value="<?php
                    echo Token::generate('csrf_login'); ?>"/>
